...
public class UserUpdateHttpTask extends AsyncTask<String, Void, String> {

    private OnDataReceivedListener mListener;

    private String json;

    public UserUpdateHttpTask(OnDataReceivedListener listener) {
        mListener = listener;
    }
